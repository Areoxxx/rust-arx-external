...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, int offset_y = 0);
    IMGUI_API void          CheckPicker(const char* label, const char* label_picker, bool* v, float col[4]);
    IMGUI_API void CheckPickerDual(const char* label, const char* label_col1, float col1[4], const char* label_col2, float col2[4], bool* v);
    IMGUI_API bool          CheckboxKeybind(const char* label, bool* v, int* key, int* keybind_mode = nullptr, float offset_x = 190.f, float offset_y = 2.f);
